...
class SplitDataset():
    def __init__(self, dataset_dir, saved_dataset_dir, train_ratio=0.8, show_progress=False):
        ...
        if not os.path.exists(self.saved_train_dir):
            os.makedirs(self.saved_train_dir)
        if not os.path.exists(self.saved_test_dir):
            os.makedirs(self.saved_test_dir)
        ...
        for item in type_path:
            ...
            for src_path in src_path_list:
                ...
                if self.show_progress:
                    print("Move file "+src_path+" to "+dst_path)
    ...
    def __split_dataset(self):
        ...
        for index in range(len(all_file_paths)):
            ...
            self.test_file_path.append([self.index_label_dict[index], file_path_list[train_num:]])
...
if __name__ == '__main__':
    ...
    # 划分数据集
# 2021-04-20 guangjinzheng split dataset
